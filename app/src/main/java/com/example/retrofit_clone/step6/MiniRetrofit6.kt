package com.example.retrofit_clone.step6

import com.example.retrofit_clone.step6.adapter.CallAdapter
import com.example.retrofit_clone.step6.adapter.DefaultCallAdapterFactory
import com.example.retrofit_clone.step6.converter.Converter
import com.example.retrofit_clone.step6.okhttp.MiniOkHttpClient
import com.example.retrofit_clone.step6.service.ServiceMethod
...
class MiniRetrofit6(
    ...
    class Builder {
        ...
        fun addConverterFactory(factory: com.example.retrofit_clone.step6.converter.GsonConverterFactory) = apply { converterFactories.add(factory) }
        fun addCallAdapterFactory(factory: CallAdapter.Factory) = apply { callAdapterFactories.add(factory) }

        fun build(): MiniRetrofit6 {
            // 기본 CallAdapterFactory를 항상 추가 (MiniCall 지원용)
            callAdapterFactories.add(DefaultCallAdapterFactory())
            return MiniRetrofit6(baseUrl, client, converterFactories, callAdapterFactories)
        }
    }
