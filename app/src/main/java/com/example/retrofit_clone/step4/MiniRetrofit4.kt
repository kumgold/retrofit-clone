package com.example.retrofit_clone.step4

import com.example.retrofit_clone.step4.adapter.CallAdapter
import com.example.retrofit_clone.step4.adapter.DefaultCallAdapterFactory
import com.example.retrofit_clone.step4.converter.Converter
import com.example.retrofit_clone.step4.okhttp.MiniOkHttpClient
import com.example.retrofit_clone.step4.okhttp.Request
import com.example.retrofit_clone.step4.retrofit.Body
import com.example.retrofit_clone.step4.retrofit.GET
import com.example.retrofit_clone.step4.retrofit.MiniCall
import com.example.retrofit_clone.step4.retrofit.POST
import com.example.retrofit_clone.step4.retrofit.Path
        ...
        return Proxy.newProxyInstance(
            ...
            object : InvocationHandler {
                override fun invoke(proxy: Any, method: Method, args: Array<out Any>?): Any {
                    ...
                    // CallAdapter & Response Converter 찾기 (기존과 동일)
