package com.example.retrofit_clone.step5

import com.example.retrofit_clone.step5.adapter.CallAdapter
import com.example.retrofit_clone.step5.adapter.DefaultCallAdapterFactory
import com.example.retrofit_clone.step5.converter.Converter
import com.example.retrofit_clone.step5.okhttp.MiniOkHttpClient
import com.example.retrofit_clone.step5.service.ServiceMethod
...
class MiniRetrofit5(
    ...
    class Builder {
        ...
        fun addConverterFactory(factory: com.example.retrofit_clone.step5.converter.GsonConverterFactory) = apply { converterFactories.add(factory) }
        fun addCallAdapterFactory(factory: CallAdapter.Factory) = apply { callAdapterFactories.add(factory) }

        fun build(): MiniRetrofit5 {
            // 기본 CallAdapterFactory를 항상 추가 (MiniCall 지원용)
            callAdapterFactories.add(DefaultCallAdapterFactory())
            return MiniRetrofit5(baseUrl, client, converterFactories, callAdapterFactories)
        }
    }
